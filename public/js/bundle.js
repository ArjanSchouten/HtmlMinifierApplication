...
},{"./minify.js":82,"bootstrap":2,"jquery":15}],2:[function(require,module,exports){
...
var vm = new Vue({
    ...
    methods: {
        minifyHtml: function minifyHtml(e) {
            ...
            alert(exports.Options.getOptions());
            $.ajax({
...
},{"./options.js":84,"jquery":15,"vue":80}],83:[function(require,module,exports){
"use strict";
...
var _optionJs2 = _interopRequireDefault(_optionJs);
    ...
    _createClass(Options, null, [{
        ...
        value: function getOptions() {
            $('#minify-options').children('input').map(function (checkbox) {
                ...
                var option = new _optionJs2['default'](name, enabled);
